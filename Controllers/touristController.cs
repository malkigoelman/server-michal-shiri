...
namespace smr.Controllers
{
    ...
    public class touristController : ControllerBase
    {
        ...
        public async Task<ActionResult> GetById(int id)
        {
            ...
            var touirst = _mapper.Map<touirstDTO>(touir);
            if (touir != null)
            {
                return Ok(touirst);
            }
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult> Put(int id, [FromBody] toirstPostModel t)
        {
        ...
        [HttpPut("status/{id}")]
        public async Task<ActionResult> Put(int id, [FromQuery] bool isActive)
        {
            var tourist = await _touristService.GetByIdAsync(id);
            if (tourist == null)
            {
                return NotFound();
            }
